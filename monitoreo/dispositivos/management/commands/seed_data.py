...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Elimina datos antiguos para evitar duplicados al correr el comando varias veces
        User.objects.filter(is_superuser=False).delete()
        Group.objects.all().delete()
        Empresa.objects.all().delete()
        # Nota: Al eliminar Empresa, las Zonas, Dispositivos y Mediciones se borran en cascada.
        ...
        for disp in dispositivos_a + dispositivos_b:
            for _ in range(random.randint(3, 7)): # Crea entre 3 y 7 mediciones por dispositivo
        ...
        self.stdout.write('Usuario A: cliente_a / password123')
        self.stdout.write('Usuario B: cliente_b / password123')